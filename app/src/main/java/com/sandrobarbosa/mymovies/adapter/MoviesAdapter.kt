...
class MoviesAdapter(
    ...
    inner class MovieViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val votes: TextView = itemView.findViewById(R.id.textVotes)
        private val popularity: TextView = itemView.findViewById(R.id.textPopularity)

        fun bind(movie: Movie) {
            title.text = movie.title
            votes.text = movie.rating.toString()
